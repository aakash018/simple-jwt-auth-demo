...
const jwt_validation_1 = require("../config/jwt_validation");
...
router.get("/data", jwt_validation_1.validate, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.get("/test-data", jwt_validation_1.validate, (_, res) => {
    console.log("Hello");
